...
$SQLite_location    = realpath($_SERVER["DOCUMENT_ROOT"]) . '/include/db/SQLite_My_Hotel.sqlite'; // I strongly recommend setting the database location outside the (www/public_html) folder.
