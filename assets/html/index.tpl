  ...
  <div class="col-lg">
    ...
    <div class="row flex-lg-row-reverse align-items-center py-2 px-3 mb-5">
      ...
      <div class="col-lg-6">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-start mt-5">
          <a href="?page=booking" class="btn btn-outline-primary px-4 me-md-2">{$BOOK_NOW}</a>
          <a href="?page=rooms" class="btn btn-outline-secondary px-4">{$VIEW_ALL}</a>
        </div>
      </div>
    </div>
    <div class="row flex-lg-row-reverse align-items-center py-2 px-3">
      ...
      <div class="col-lg-6">
        ...
        <div class="d-grid gap-2 d-md-flex justify-content-md-start mt-5">
          <a href="?page=services" class="btn btn-outline-primary px-4 me-md-2">{$VIEW_ALL}</a>
        </div>
      </div>
    </div>
